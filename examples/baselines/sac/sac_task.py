...
class Args:
    ...
    env_id: str = "MobilePutCubeIntoRefrigerator-v1"
...
class Logger:
    ...
    def add_scalar(self, tag, scalar_value, step):
        if self.log_wandb:
            wandb.log({tag: scalar_value}, step=step*10)
...
if __name__ == "__main__":
    ...
    while global_step < args.total_timesteps:
        if global_step % args.eval_freq == 0:
            ...
            if empty is True:
                eval_metrics_mean['reward'] = final_info['reward']
                eval_metrics_mean['return'] = final_info['return']
                eval_metrics_mean['episode_len'] = final_info['episode_len']
                eval_metrics_mean['success_once'] = final_info['success_once']
                eval_metrics_mean['success_at_end'] = final_info['success_at_end']
